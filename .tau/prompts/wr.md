---
description: Finish the current task end-to-end with a commit and push
...
6. If this task is tied to exactly one GitHub issue, explicitly close that issue with reason `completed` after the push. This applies to issues only, not PRs.
