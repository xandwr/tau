...
describe("resource formatting helpers", () => {
	it("formats skill invocations with additional instructions", () => {
		const skill = {
			...
			filePath: "/project/.tau/skills/inspect/SKILL.md",
		};

		expect(formatSkillInvocation(skill, "Check errors.")).toBe(
			'<skill name="inspect" location="/project/.tau/skills/inspect/SKILL.md">\nReferences are relative to /project/.tau/skills/inspect.\n\nUse inspection tools.\n</skill>\n\nCheck errors.',
		);
	});
