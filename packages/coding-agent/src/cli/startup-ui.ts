...
const OFFICIAL_APP_NAME = "tau";
const OFFICIAL_CONFIG_DIR_NAME = ".tau";
 ...
 * - this is the official Tau distribution (not a fork/rebrand)
 * - experimental features are enabled (TAU_EXPERIMENTAL=1)
