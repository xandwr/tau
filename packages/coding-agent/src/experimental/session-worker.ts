...
export const SESSION_WORKER_CONTROL_ADDRESS_ENV = "TAU_SESSION_WORKER_CONTROL_ADDRESS";
export const SESSION_WORKER_CONTROL_TOKEN_ENV = "TAU_SESSION_WORKER_CONTROL_TOKEN";
export const SESSION_WORKER_SESSION_KEY_ENV = "TAU_SESSION_WORKER_SESSION_KEY_BASE64";
export const SESSION_WORKER_PEER_ID_ENV = "TAU_SESSION_WORKER_PEER_ID";
...
export const SESSION_WORKER_INITIAL_DEMAND_GRACE_ENV = "__TAU_SESSION_WORKER_INITIAL_DEMAND_GRACE_MS";
export const SESSION_WORKER_ORPHAN_DEMAND_GRACE_ENV = "__TAU_SESSION_WORKER_ORPHAN_DEMAND_GRACE_MS";
